...
export const Logo: React.FC<IconInterface> = ({width = 24,height= 24, classNames}) => {
    return (
        <svg className={classNames} width={width} height={height} viewBox="0 0 267 302" fill="none" xmlns="http://www.w3.org/2000/svg">
